...
See the official https://pester.dev/docs/commands/Mock[Pester Mock command] reference.
...
See the official https://docs.pytest.org/en/stable/how-to/fixtures.html[pytest fixture] and https://docs.pytest.org/en/stable/how-to/monkeypatch.html[monkeypatch] guides.
...
Microsoft’s https://learn.microsoft.com/en-us/ef/core/testing/choosing-a-testing-strategy[EF Core testing strategy] describes SQLite, in-memory-provider, and query differences.

Testcontainers provides https://testcontainers.com/guides/getting-started-with-testcontainers-for-dotnet/[database testing guides] for disposable real engines.
...
See Microsoft’s https://learn.microsoft.com/en-us/aspnet/core/test/integration-tests[ASP.NET Core integration-test guidance] and https://learn.microsoft.com/en-us/ef/core/testing/[EF Core testing overview].
